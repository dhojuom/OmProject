...
<html lang="en">
  ...
  <body>
		...
		<div class="panel panel-default ">
		  <!-- Default panel contents -->
		  <div class="panel-heading"><h2>Courses Enrolled</h2></div>
		  <!-- Table -->
		  <table class="table">
		    <tr>
							...
							<td width="300">click to Unenroll</td>
						...
						<tr>
							...
							<td width="300">
							<input type= "checkbox" name= "check_list[]" value="<?php echo 			$enrollment->course->id;?>">
							</td>
						</tr>
		...
		<div class="row">
			<div class= "col-md-4 col-md-offset-5">
				<?php 
					if ($bool)
					{
						?> <h2>No course to unenroll</h2> <?php
					}
